...
export const ar = {
  ...
  totalRiskScoreDesc: `كيف يُحسب؟ لكل مخالفة نقاط حسب نوعها:
• الاعتداء الجسدي = 5 نقاط
• الإساءة اللفظية = 4 نقاط  
• حجب/العبث بالكاميرا = 3 نقاط
• التدخين/الصراخ/ثبات الكاميرا = 2 نقاط

ثم تُضرب في شدة المخالفة:
• عالية × 1.0 | متوسطة × 0.6 | منخفضة × 0.3

مثال: اعتداء جسدي (5) بشدة عالية (×1) = 5 نقاط
+ تدخين (2) بشدة متوسطة (×0.6) = 1.2 نقطة
= المجموع: 6.2 نقطة`,
