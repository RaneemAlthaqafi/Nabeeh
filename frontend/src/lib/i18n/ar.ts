...
export const ar = {
  ...
  totalRiskScoreDesc: `تصنيف مستوى الخطورة:
🟢 0-20% = منخفضة (وضع آمن)
🟡 20-50% = متوسطة (يحتاج متابعة)
🔴 50-100% = عالية (يتطلب تدخل)

كيف تُحسب؟
مجموع النقاط ÷ 50 × 100 = النسبة%

الحد المرجعي: 50 نقطة = 100%
25 نقطة = 50% (بداية الخطورة العالية)
10 نقاط = 20% (بداية الخطورة المتوسطة)`,
