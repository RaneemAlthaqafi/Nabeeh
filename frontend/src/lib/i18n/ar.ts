...
export const ar = {
  ...
  totalRiskScoreDesc: `ماذا تعني هذه النسبة؟

🟢 0% - 20% = وضع آمن
    لا توجد مخاطر تذكر، الوضع تحت السيطرة

🟡 20% - 50% = يحتاج متابعة
    مخاطر متوسطة، ينصح بالمراقبة

🔴 50% - 100% = يتطلب تدخل فوري
    مخاطر عالية، يجب اتخاذ إجراء

━━━━━━━━━━━━━━━━━━━━━━━

كيف تُحسب النسبة؟

الخطوة 1: نجمع نقاط كل المخالفات
الخطوة 2: نقسم على عدد المنافذ المتأثرة
الخطوة 3: نقسم على 50 ونضرب في 100

مثال عملي:
• مجموع النقاط: 80 نقطة
• عدد المنافذ: 4 منافذ
• المتوسط: 80 ÷ 4 = 20 نقطة لكل منفذ
• النسبة: (20 ÷ 50) × 100 = 40% 🟡`,
